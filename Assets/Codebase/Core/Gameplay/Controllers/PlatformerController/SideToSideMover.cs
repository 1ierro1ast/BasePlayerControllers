...
namespace Codebase.Core.Gameplay.Controllers.PlatformerController
{
    public class SideToSideMover : BoundMover
    {
        ...
        protected override void OnMove()
        {
            ...
            _direction = (_inputService.HorizontalSpeed * cachedTransform.right).normalized;
